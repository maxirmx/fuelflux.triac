...
This Demo has been verified using the 2-CH_SCR_HAT. 
...
Raspberry Pi
    Installation BCM2835
        # The version may have been updated. Take the 1.60 version as an 
        # example. It is actually recommended to use the latest version
        # More versions can refer to the official website：
